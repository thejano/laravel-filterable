...
3. Passing Filterable class to `filterableClass()` method of the model.
```php
<?php
...
3. Passing as a parameter to `fliterable()` scope of your model. The scope accepts 3 parameters
```php
