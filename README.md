...
# Add filtiration functionality to Larvel Models
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-filterable.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-filterable)
...
```bash
php artisan vendor:publish --tag="laravel-filterable-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-filterable-views"
```

## Usage

```php
$laravelFilterable = new TheJano\LaravelFilterable();
echo $laravelFilterable->echoPhrase('Hello, TheJano!');
```
